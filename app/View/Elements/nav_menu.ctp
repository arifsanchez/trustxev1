...
<div id="navi">
	<div id="navi-cm">
		<?php echo $this->Html->link(
			...
			'onmouseover' => 'MM_swapImage(\'Image2\', \'\', \'../img/layout/txe-menu-homeON.gif\',1)')
		);?>
	</div>
	...
	<div id="navi-cm">
		<?php echo $this->Html->link(
			...
			array('escape' => false,'onmouseout' => 'MM_swapImgRestore()',
			'onmouseover' => 'MM_swapImage(\'Image3\', \'\', \'../img/layout/txe-menu-buyON.gif\',1)')
		);?>
	</div>
	...
	<div id="navi-cm">
		<?php echo $this->Html->link(
			...
			array('escape' => false,'onmouseout' => 'MM_swapImgRestore()',
			'onmouseover' => 'MM_swapImage(\'Image4\', \'\', \'../img/layout/txe-menu-sellON.gif\',1)')
		);?>
	</div>
	...
	<div id="navi-cm">
		<?php echo $this->Html->link(
			...
			"/pages/about_us",
			array('escape' => false,'onmouseout' => 'MM_swapImgRestore()',
			'onmouseover' => 'MM_swapImage(\'Image5\', \'\', \'../img/layout/txe-menu-aboutON.gif\',1)')
		);?>
	</div>
	...
	<div id="navi-cm">
		<?php echo $this->Html->link(
			...
			"/pages/contact_us",
			array('escape' => false,'onmouseout' => 'MM_swapImgRestore()',
			'onmouseover' => 'MM_swapImage(\'Image6\', \'\', \'../img/layout/txe-menu-contactON.gif\',1)')
		);?>
	</div>
	...
	<div id="navi-cm">
		<?php echo $this->Html->link(
			...
			"/pages/support",
			array('escape' => false,'onmouseout' => 'MM_swapImgRestore()',
			'onmouseover' => 'MM_swapImage(\'Image7\', \'\', \'../img/layout/txe-menu-supportON.gif\',1)')
		);?>
	</div>
