<div class="userEcurrs index">
	<h2><?php echo __('My eCurrency'); ?></h2>
	...
	<?php
	foreach ($user_leave as $userEcurr): ?>
	<tr>
		<td>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('plugin' => '', 'controller' => 'user_ecurrs','action' => 'viewmyec', $userEcurr['UserEcurr']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('plugin' => '', 'controller' => 'user_ecurrs','action' => 'editmyec', $userEcurr['UserEcurr']['id'])); ?>
